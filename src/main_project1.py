...
def main():
    ...
    T_pred = T0 + (T1 - T0) * theta_pred
    T_exact = T0 + (T1 - T0) * theta_exact
    ...
    np.save(os.path.join(results_dir, "abs_err.npy"), abs_err)
